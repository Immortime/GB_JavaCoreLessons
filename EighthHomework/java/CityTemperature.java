...
public class CityTemperature {
	...
	public static String getCityTemp() throws IOException {
		...
		String tempForDay = objectMapper.readTree(jsonOfWeather).at("/DailyForecasts").get(0).at("/Temperature/Minimum/Value").asText();
